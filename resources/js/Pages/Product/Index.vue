        ...
        <template #header>
            ...
            >
                ...
                <div class="flex items-center gap-3">
                    <a
                        v-if="permissions.includes('export-products')"
                    ...
                    <Link
                        v-if="permissions.includes('import-products')"
                        :href="route('products.import')"
                        class="inline-flex items-center justify-center rounded-lg border border-indigo-600 bg-white px-4 py-2.5 text-sm font-semibold text-indigo-700 hover:bg-indigo-50"
                    >
                        Importar Excel
                    </Link>
                </div>
